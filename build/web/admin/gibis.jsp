...
<main>
        <section id="actions" style="padding-top: 150px; min-height: 80vh">
                ...
                <div class="form-group search">
                    <form method="GET" action="GibiWS">
                        <input type="text" class="form-control search mb-3" placeholder="Pesquisar Gibi..." name="txtFiltro"/>
                    </form>
                </div>
                <div class="row">
                        ...
                        <div class="col-md-4 col-lg-3">
                            <div class="heroi mb-3">
                                <div class="heroi__img">
                                    <a href=""><img src="../images/loading.gif" data-src="${g.url}" class="lazy" alt=""></a>
                                </div>
