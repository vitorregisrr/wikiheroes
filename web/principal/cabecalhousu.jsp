...
<body class="scrollbar-inner wow fadeIn">
    <header id="main-header">
        <nav id="main-nav" class="navbar navbar-expand-lg fixed-top">
            <div class="container">
                <div class="navbar-brand wow fadeInLeft"><span class="logo"><a href="../principal/IndexWS" style="text-decoration: none; color: white">WikiHeroes</a></span></div>
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav ml-auto">
                        <li class="nav-item wowNonMobile fadeInDown" data-wow-delay="0.6s">
                            <a class="nav-link" href="../principal/GibisUsuWS?txtAcao=gibi">Gibis</a>
                        </li>
                        <li class="nav-item wowNonMobile fadeInDown" data-wow-delay="0.6s">
                            <a class="nav-link" href="../principal/GibisUsuWS?txtAcao=liga">Ligas</a>
                        </li>
                        <li class="nav-item wowNonMobile fadeInDown" data-wow-delay="0.6s">
                            <a class="nav-link" href="../principal/GibisUsuWS">Herois</a>
                        </li>
                        <li class="nav-item nav-btn wowNonMobile bounceInDown" data-wow-delay="0.8s">
                            <a class="nav-link btn-main--outline" role="button" href="LogarWS"><i
                                    class="fa fa-sign-in mr-2"></i>Logar</a>
                        </li>
                    </ul>
                </div>
            </div>
