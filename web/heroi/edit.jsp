...
<main>
        <section id="actions" style="padding-top: 150px; min-height: 80vh">
            <h3 class="inner-title mb-3">Editar Herói</h3>
            <div class="container">
                <div class="row">
                        ...
                        <form action="HeroiWS" method="POST">
                            <div class="row">
                                <div class="form-group">
                                    <input type="text" name="txtId" class="form-control" placeholder="Id" value="${heroi.id}" readonly>
                                </div>
                                <div class="form-group">
                                    <input type="text" name="txtNome" class="form-control" placeholder="Nome" value="${heroi.nome}">
                                </div>
                                <div class="form-group">
                                    <input id="urlInput" type="text" name="txtUrl" class="form-control" placeholder="URL da Imagem" value="${heroi.url}">
                                ...
                                <div class="form-group">
                                    <input type="text" name="txtPoder" class="form-control" placeholder="Poder" value="${heroi.poder}">
                                </div>
                                <div class="form-group">
                                    <input type="text" name="txtFraqueza" class="form-control" placeholder="Fraqueza" value="${heroi.fraqueza}">
                                </div>
                                <div class="form-group">
